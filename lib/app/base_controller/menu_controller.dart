...
List<MenuItem> sideMenuItemRoutes = [
  ...
  MenuItem(
    ...
    subMenuItems: [
      MenuItem("Items", itemsPageRoute, icon: Icons.add_circle_rounded),
      MenuItem("Item Groups", itemGroupsPageRoute,
  ...
  MenuItem(salesPageDisplayName, salesPageRoute, subMenuItems: [
    MenuItem("Customers", customersPageRoute, icon: Icons.add_circle_rounded),
    MenuItem("Sales Orders", salesOrdersPageRoute,
        icon: Icons.add_circle_rounded),
    MenuItem("Packages", packagesPageRoute, icon: Icons.add_circle_rounded),
    MenuItem("Shipments", shipmentsPageRoute, icon: Icons.add_circle_rounded),
    MenuItem("Invoices", invoicesPageRoute, icon: Icons.add_circle_rounded),
    MenuItem("Sales Receipts", salesReceiptsPageRoute,
        icon: Icons.add_circle_rounded),
    MenuItem("Payments Received", paymentsReceivedPageRoute,
        icon: Icons.add_circle_rounded),
    MenuItem("Sales Returns", salesReturnsPageRoute,
        icon: Icons.add_circle_rounded),
    MenuItem("Credit Notes", creditNotesPageRoute,
        icon: Icons.add_circle_rounded),
  ]),
  MenuItem(purchasesPageDisplayName, purchasesPageRoute, subMenuItems: [
    MenuItem("Vendors", vendorsPageRoute, icon: Icons.add_circle_rounded),
    MenuItem("Purchase Orders", purchaseOrdersPageRoute,
        icon: Icons.add_circle_rounded),
    MenuItem("Purchase Receives", purchasesReceivesPageRoute,
        icon: Icons.add_circle_rounded),
    MenuItem("Bills", billsPageRoute, icon: Icons.add_circle_rounded),
    MenuItem("Payments Made", paymentsMadePageRoute,
        icon: Icons.add_circle_rounded),
    MenuItem("Vendor Credits", vendorCreditsPageRoute,
        icon: Icons.add_circle_rounded),
  ]),
